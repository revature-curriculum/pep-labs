...
public class DeleteRecords {
    ...
    /**
     * Assignment: In the problem1.sql, write the SQL command to delete everyone named "Steve" from the site_user table,
     * assuming that the table and "Steve" records already exist.
     *
     *        site_user table:
     *        |   id  |     firstname        |
     *        --------------------------------
