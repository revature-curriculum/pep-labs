package SQL_Basic.DML._8_UPDATING_RECORDS;
...
public class UpdateARecordTest {
    ...
    /**
     * In this test we are querying everything in the users table to ensure that Brandon was successfully updated to "Chad".
     */
    @Test
    public void problem2Test(){
        ...
        User user3 = new User(3,"Steve","Jones");
        User user4 = new User(4, "Chad", "Irving");
        User user5 = new User(5,"Adam","Jones");
        List<User> expectedResult = new ArrayList<>();
        expectedResult.add(user1);
        expectedResult.add(user2);
    ...
    /**
     * In this test we are querying everything in the users table to ensure that both Steve's were updated to Steven.
     */
    @Test
    public void problem3Test(){
        //arrange
        User user1 = new User(1,"Steven","Garcia");
        User user2 = new User(2,"Alexa", "Smith");
        User user3 = new User(3,"Steven","Jones");
        User user4 = new User(4, "Brandon", "Smith");
        User user5 = new User(5,"Adam","Jones");
        List<User> expectedResult = new ArrayList<>();
        expectedResult.add(user1);
