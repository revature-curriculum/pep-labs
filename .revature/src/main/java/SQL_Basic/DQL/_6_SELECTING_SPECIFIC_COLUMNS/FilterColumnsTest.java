...
public class FilterColumnsTest {
    ...
    /**
     * This test compares the result of the problem1 method to the hardcoded values below which ensures that only the firstname column is retrieved.
     */
    @Test
    ...
    /**
     * This test compares the result of the problem2 method to the hardcoded values below which ensures that only the lastname column is retrieved.
     */
    @Test
    public void problem2Test(){
        //arrange
        User user1 = new User(0,null,"Garcia");
        User user2 = new User(0,null, "Smith");
        User user3 = new User(0,null,"Jones");
        User user4 = new User(0, null, "Smith");
        User user5 = new User(0,null,"Jones");
        List<User> expectedResult = new ArrayList<>();
        expectedResult.add(user1);
        expectedResult.add(user2);
        expectedResult.add(user3);
        ...
        //act
        List<User> actualResult = filterColumns.problem2();
    ...
    /**
     * This test compares the result of the problem3 method to the hardcoded values below which ensures that only the firstname AND lastname columns were retrieved.
     */
    @Test
    public void problem3Test(){
        //arrange
        User user1 = new User(0,"Steve","Garcia");
        User user2 = new User(0,"Alexa", "Smith");
        User user3 = new User(0,"Steve","Jones");
        User user4 = new User(0, "Brandon", "Smith");
        User user5 = new User(0,"Adam","Jones");
        List<User> expectedResult = new ArrayList<>();
        expectedResult.add(user1);
        expectedResult.add(user2);
        expectedResult.add(user3);
        ...
        //act
        List<User> actualResult = filterColumns.problem3();
